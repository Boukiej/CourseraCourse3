...
download.file(URL,destfile="./data/DatasetCoursera.zip")

##unzip files
unzip(zipfile="./data/DatasetCoursera.zip",exdir="./data")
...
write.table(Export, file = "TidyData.txt",row.name=FALSE)
